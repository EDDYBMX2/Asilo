...
<head>
  ...
  <title>Login</title>
    ...
    <meta name="keywords" content="Asilo de Ancianos cabeza de algodon"
    />
    <!-- /meta tags -->
    <!-- custom style sheet -->
...
<body>
    <center>
    <h1>ASILO DE ANCIANOS <BR>CABEZA DE ALGODÓN</BR></h1>
    </center>
    ...
    <form action="login.php" method="post">
        ...
        <p class=" w3l-register-p">Inicia Sesión<a href="index.php" class="register" target="_blank">  aqui</a></p>
    </div>
    <footer>
        <br></br>
        <br></br>
        ...
        <p>Todos los derechos reservados Asilo de ancianos cabeza de algodón 2022. </p>
