...
<?php
   // $branch=$_SESSION['branch'];
    $query=mysqli_query($con,"select * from procedimiento_pago where id_procedimiento_pago= '$id_pro' ")or die(mysqli_error());
    $i=1;
...
?>
        ...
        <form class="form-horizontal" method="post" action="procedimiento_pago_actualizar.php" enctype='multipart/form-data'>
            <input type="hidden" class="form-control" id="id_procedimiento_pago" name="id_procedimiento_pago" value="<?php echo $id_pro;?>" required>
