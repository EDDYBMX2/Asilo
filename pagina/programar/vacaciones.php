...
?>
              ...
              <td><?php echo $row['fecha'];?></td>
                    ...
                    //  if ($eliminar=="si") {
                      ...
                      ?>
   <a class="small-box-footer btn-print"  href="<?php  echo "../programar/eliminar_vacaciones.php?id_vacaciones=$id_vacaciones";?>" onClick="return confirm('¿Está seguro de que quieres eliminar horario medico??');"><i class="glyphicon glyphicon-remove"></i></a>
   <?php
                  //    }
                      ?>
                               <?php
