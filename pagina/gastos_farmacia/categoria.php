...
<?php
   ...
   // $branch=$_SESSION['branch'];
    $query=mysqli_query($con,"select * from categoria_gastos_farmacia  ")or die(mysqli_error());
    $i=1;
...
?>
              ...
              <td><?php echo $row['descripcion'];?></td>
                    ...
                    //  if ($eliminar=="si") {
                      ...
                      ?>
   <a class="small-box-footer btn-print"  href="<?php  echo "../gastos_farmacia/eliminar_categoria.php?id_categoria=$id_categoria";?>" onClick="return confirm('¿Está seguro de que quieres eliminar Categoria gastos??');"><i class="glyphicon glyphicon-remove"></i></a>
   <?php
                  //    }
                      ?>
                               <?php
