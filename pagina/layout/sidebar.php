              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                      ...
                      ?>
                          ...
                          <li><a><i class="fa fa-database"></i> Medico General<span class="fa fa-chevron-down"></span></a>
       ...
       <li><a href = "../preescripcion/preescripcion_paciente.php"><i class="fa fa-archive"></i> preescripcion paciente<span class="fa fa-chevron-right"></span></a>
           ...
           <?php
                      ...
                      ?>
                                  ...
                                  <li><a><i class="fa fa-user"></i> Asociación<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">

   <li><a href="../medico/medico.php">Medico General</a></li>
        <li><a href="../farmaceutico/farmaceutico.php">farmaceutico</a></li>

 <li><a href="../recepcionista/recepcionista.php">Recepcionista Asilo</a></li>
