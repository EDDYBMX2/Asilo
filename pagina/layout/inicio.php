...
?>
            ...
            <?php echo ($num > 0) ? '<a href="../medico/medico.php" class="small-box-footer">Mas info<i class="fa fa-arrow-circle-right"></i></a>' : '<a href="#" class="small-box-footer">-------</a>'; ?>
          </div>
        </div>
...
?>
              ...
              <p>Información del Asilo</p>
            </div>
            <div class="icon"><img height="80" width="80" src="img/informacion.png">
              <i class=""></i>
            </div>
...
?>
              ...
              <p> Ancianos Pacientes</p>
            </div>
            <div class="icon"><img height="80" width="80" src="img/ancianos1.png">
              <i class=""></i>
            </div>
            <?php echo ($num > 0) ? '<a href="../paciente/paciente.php" class="small-box-footer">Mas info<i class="fa fa-arrow-circle-right"></i></a>' : '<a href="#" class="small-box-footer">-------</a>'; ?>
          </div>
        </div>
                    <?php
                      }
...
?>
            ...
            <div class="icon"><img height="80" width="80" src="img/citas.png">
              <i class=""></i>
            </div>
            <?php echo ($num > 0) ? '<a href="../cita/cita_paciente.php" class="small-box-footer">Mas info<i class="fa fa-arrow-circle-right"></i></a>' : '<a href="#" class="small-box-footer">-------</a>'; ?>
          </div>
        </div>
                    <?php
                      }
...
?>
            ...
            <?php echo ($num > 0) ? '<a href="../cita/cita.php" class="small-box-footer">Mas info<i class="fa fa-arrow-circle-right"></i></a>' : '<a href="#" class="small-box-footer">-------</a>'; ?>
          </div>
        </div>
          <?php
                      }
...
?>
            ...
            <div class="icon"><img height="80" width="80" src="img/ficha.png">
              <i class=""></i>
            </div>
            <?php echo ($num > 0) ? '<a href="../preescripcion/preescripcion.php" class="small-box-footer">Mas info<i class="fa fa-arrow-circle-right"></i></a>' : '<a href="#" class="small-box-footer">-------</a>'; ?>
          </div>
        </div>
          <?php
                      }
...
?>
            ...
            <div class="icon"><img height="80" width="80" src="img/pago_servicios.png">
              <i class=""></i>
            </div>
