...
?>
        ...
        <form class="form-horizontal" method="post" action="medicina_actualizar.php" enctype='multipart/form-data'>
        ...
        <div class="row">
                    <div class="col-md-3 btn-print">
                      <div class="form-group">
                       ...
                       <div class="col-md-4 btn-print">
                      <div class="form-group">
<textarea class="form-control" id="precio_compra" name="precio_compra" ><?php echo $row['precio_compra'];?></textarea>
