...
<?php
   ...
   // $branch=$_SESSION['branch'];
    $query=mysqli_query($con,"select * from vacaciones where id_medico='$cid' ")or die(mysqli_error());
    $i=1;
...
?>
              ...
              <td><?php echo $row['fecha'];?></td>
                    ...
                    //  if ($eliminar=="si") {
                      ...
                      ?>
   <a class="small-box-footer btn-print"  href="<?php  echo "../vacaciones/eliminar_vacaciones.php?id_vacaciones=$id_vacaciones&cid=$cid";?>" onClick="return confirm('¿Está seguro de que quieres eliminar horario medico??');"><i class="glyphicon glyphicon-remove"></i></a>
   <?php
                  //    }
                      ?>
                               <?php
